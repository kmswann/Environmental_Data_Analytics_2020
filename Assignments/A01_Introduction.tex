...
\begin{quote}
Answer: I played with R for stats 710 (stata based) to look at hydro
data (I used Lauren Patterson's bootcamp)
\end{quote}
...
\begin{quote}
Answer:
\url{https://github.com/kmswann/Environmental_Data_Analytics_2020}
\end{quote}
