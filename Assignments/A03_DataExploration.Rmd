...
```{r,  message = FALSE}
setwd("C:/Users/krist/Box Sync/Spring 2020/R/Environmental_Data_Analytics_2020")
...
> Answer: 
*Plots have specific dimensions with specific measurements at different locations within the plots.
*Sampling occurs at different intervals based on plant community.
*
...
> Answer: Factor; it's a character string...
