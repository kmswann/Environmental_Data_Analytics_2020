...
pass <- c(TRUE,TRUE,FALSE,FALSE) #logical
...
> Answer: It's not a matrix...it's more like a csv...it doesn't have the same requirements as matrices would have for dimensions, and you can't do linear algebra on it. 
...
```{r}
Passing <- function(scores) {if scores > 60 {names} else {names}}
